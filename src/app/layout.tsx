...
export const metadata: Metadata = {
  title: "Luxe Stay - Luxury Hotel Experience",
  description: "Discover award-winning luxury accommodation with premium amenities, fine dining, and exceptional service. Book your perfect escape today.",
  keywords: "luxury hotel, luxury accommodation, fine dining, spa, premium rooms, city hotel, luxury stay",
  metadataBase: new URL("https://luxestay.com"),
  alternates: {
    canonical: "https://luxestay.com"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Luxe Stay - Your Sanctuary of Elegance",
    description: "Experience luxury redefined. Award-winning hotel with premium rooms, world-class amenities, and exceptional hospitality.",
    url: "https://luxestay.com",
    siteName: "Luxe Stay Hotel",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763919363765-8vsx53w9.jpg",
      alt: "Luxury hotel lobby entrance"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Luxe Stay - Luxury Hotel Experience",
    description: "Discover your sanctuary in our award-winning hotel with luxury rooms and world-class amenities.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763919363765-8vsx53w9.jpg"]
  }
};
